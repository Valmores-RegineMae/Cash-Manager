...
class FoodAndDrinkPage extends StatefulWidget {
  @override
  _FoodAndDrinkPageState createState() => _FoodAndDrinkPageState();
}

class _FoodAndDrinkPageState extends State<FoodAndDrinkPage> {
